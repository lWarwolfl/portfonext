            ...
            <StyledCard move={false} glow="blue" variant="narrowbottom">
               ...
               <div className={styles.splittext}>
                  <div className={styles.description}>
                     ...
                     <span className={styles.bold}>frontend development</span> I possess a diverse
                     skill set of <span className={styles.bold}>25+ technical abilities</span>.{' '}
                     ...
                     committed to staying <span className={styles.bold}>up-to-date</span> with the
